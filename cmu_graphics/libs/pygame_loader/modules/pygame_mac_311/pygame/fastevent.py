...
from cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame import error, register_quit
...
def init():
    ...
    """
    global _ft_init
    if not cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.display.get_init():
...
def pump():
    ...
    """
    _ft_init_check()
    cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.event.pump()
...
def wait():
    ...
    """
    _ft_init_check()
    return cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.event.wait()
...
def poll():
    ...
    """
    _ft_init_check()
    return cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.event.poll()
...
def get():
    ...
    """
    _ft_init_check()
    return cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.event.get()
...
def post(event: Event):
    ...
    """
    _ft_init_check()
    cmu_graphics.libs.pygame_loader.modules.pygame_mac_311.pygame.event.post(event)
