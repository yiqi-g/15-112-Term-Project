...
class Camera:
    ...
    def get_surface(self, dest_surf=None):
        ...
        if not abuffer:
            return None
        surf = cmu_graphics.libs.pygame_loader.modules.pygame_win_64_312.pygame.image.frombuffer(abuffer, (width, height), "BGR")
        surf = cmu_graphics.libs.pygame_loader.modules.pygame_win_64_312.pygame.transform.flip(surf, 0, 1)
