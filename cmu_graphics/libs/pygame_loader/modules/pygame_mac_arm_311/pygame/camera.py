...
from cmu_graphics.libs.pygame_loader.modules.pygame_mac_arm_311.pygame import error
...
def _setup_backend(backend):
    ...
    if backend == "opencv-mac":
        from cmu_graphics.libs.pygame_loader.modules.pygame_mac_arm_311.pygame import _camera_opencv
        ...
        from cmu_graphics.libs.pygame_loader.modules.pygame_mac_arm_311.pygame import _camera_vidcapture
