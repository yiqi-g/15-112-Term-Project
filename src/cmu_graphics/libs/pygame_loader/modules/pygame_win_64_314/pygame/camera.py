...
from src.cmu_graphics.libs.pygame_loader.modules.pygame_win_64_314.pygame import error
...
def _setup_backend(backend):
    ...
    if backend == "opencv-mac":
        from src.cmu_graphics.libs.pygame_loader.modules.pygame_win_64_314.pygame import _camera_opencv
