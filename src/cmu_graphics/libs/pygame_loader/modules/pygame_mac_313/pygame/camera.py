...
from src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame import error
...
def _setup_backend(backend):
    ...
    if backend == "opencv-mac":
        from src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame import _camera_opencv
        ...
        from src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame import _camera_vidcapture
