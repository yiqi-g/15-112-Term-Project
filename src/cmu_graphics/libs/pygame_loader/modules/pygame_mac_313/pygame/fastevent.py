...
from src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame import error, register_quit
from src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event import Event
...
def init():
    ...
    """
    global _ft_init
    if not src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.display.get_init():
...
def pump():
    ...
    """
    _ft_init_check()
    src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event.pump()
...
def wait():
    ...
    """
    _ft_init_check()
    return src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event.wait()
...
def poll():
    ...
    """
    _ft_init_check()
    return src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event.poll()
...
def get():
    ...
    """
    _ft_init_check()
    return src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event.get()
...
def post(event: Event):
    ...
    """
    _ft_init_check()
    src.cmu_graphics.libs.pygame_loader.modules.pygame_mac_313.pygame.event.post(event)
